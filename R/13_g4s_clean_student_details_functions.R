...
#' Get clean student details.
#'
#' Returns clean student details for chosen academic year.
#' @param academicYear academic year as integer.
#' @examples
#' gfs_clean_student_details(2021)
#' @export
gfs_clean_student_details <- function(academicYear) {
  ## Mesaage
  ...
  #df_students_general_02 <- dplyr::filter(df_students_general_02, !grepl(pattern = "wbr", x = name, ignore.case = TRUE))
