...
There are some API calls that are yet to be included.  The only reason for thier absence is that I have not needed to use them yet.
...
If you have never used `R` before, or you only ever use it once or twice a year, the following will do:
...
Anything other than a status code 200 means there was an error along the way.  See https://www.go4schools.com/Documentation/V1/APIDocumentation.html#errors to identify the error.
